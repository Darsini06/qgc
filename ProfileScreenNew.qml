...
Item {
  ...
  StackLayout {
    ...
    currentIndex: {
      ...
      else if (currentView === "drone") return 1
      else if (currentView === "accountUpdate") return 2
      else if (currentView === "reports") return 3
      else if (currentView === "feedback") return 4
      else if (currentView === "privacy_policy") return 5
      else if (currentView === "terms&conditions") return 6
      else return 0
    }
                           ...
                           delegate: Button {
                               ...
                               Item {
                                       ...
                                       QGCColoredImage {
                                           ...
                                           source: "qrc:/qmlimages/check.svg"  // ✅ Your tick icon
                                           width: 24
                                           height: 24
