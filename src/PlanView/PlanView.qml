...
console.log("PlanView creater", _planMasterController.planCreators);
    ...
    Item {
        ...
        anchors.left:   parent.left
        anchors.right:  parent.right
        anchors.top:    parent.top//planToolBar.bottom
        anchors.bottom: parent.bottom
            ...
            ToolStripActionList {
                ...
                //     },
                    ToolStripAction {
                        ...
                        visible:            true//QGroundControl.loadGlobalSetting("waypoint","waypoint1")==="waypoint"?true:false//planType==="Plan"?false:toolStrip._isRallyLayer || toolStrip._isMissionLayer || toolStrip._isUtmspLayer
                        checkable:          true
                    }
                //     ToolStripAction {
...
//         // Call createPlan automatically
//         if (_planMasterController.planCreators.length > 0) {
//             var centerPoint = Qt.point(editorMap.centerViewport.left + (editorMap.centerViewport.width / 2),
//                                        editorMap.centerViewport.top + (editorMap.centerViewport.height / 2))
//             var centerCoord = editorMap.toCoordinate(centerPoint, false)
//             _planMasterController.planCreators[0].createPlan(centerCoord)
...
//                         iconSource:         "/qmlimages/MapAddMission.svg"
//                         enabled:            toolStrip._isRallyLayer ? true : _missionController.flyThroughCommandsAllowed
//                         visible:            true//planType==="Plan"?false:toolStrip._isRallyLayer || toolStrip._isMissionLayer || toolStrip._isUtmspLayer
//                         checkable:          true
//                     }
//                     //     ToolStripAction {
//                     //         text:               _missionController.isROIActive ? qsTr("Cancel ROI") : qsTr("ROI")
...
//     }
//     function newmap() {
//         // if (selectedPlanCreator) {
//         //         console.log("newmap")
//         //         selectedPlanCreator.createPlan(_mapCenter())
//         //     } else {
//         //         console.log("No plan creator selected")
//         //     }
