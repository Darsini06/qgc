            ...
            Column {
                ...
                Column {
                    ...
                    Rectangle {
                        ...
                        width:              parent.width
                        height:             fenceMainCol.implicitHeight + (ScreenTools.defaultFontPixelHeight * 1.6)
            ...
            ScrollView {
                ...
                Column {
                    ...
                    Loader {
                        ...
                        onLoaded: {
                            if (item) {
                                if (itemEditPopup.popupMissionItem && itemEditPopup.popupMissionItem.commandName === "Spot Spraying") {
