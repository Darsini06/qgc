...
Item {
    ...
    property bool   _showPercentage:    (_indicatorDisplay && _indicatorDisplay.rawValue === 0)
    property bool   _showVoltage:       (_indicatorDisplay && _indicatorDisplay.rawValue === 1)
    property bool   _showBoth:          (_indicatorDisplay && _indicatorDisplay.rawValue === 2)
