    ...
    , _dirty(false)
{
    ...
    if (!kmlOrShpFile.isEmpty()) {
        ...
        // Use ShapeFileHelper to load the coordinates. It will extract Point nodes if no Polygon is found,
        // and it correctly handles Android content:// URIs via JNI under the hood.
